...
| FR-004 | Provider/shared runway clock | Challenger idea | liquidity | Internal deterministic forecast service implemented; /api/v1/liquidity-forecasts planned | Analytics visualization module implemented; API integration pending | Unit and Neon PostgreSQL forecast tests | MET-001, MET-002 | DEMO-001 | Implemented |
| FR-005 | Primary anomaly pattern | Locked MVP | anomaly | Internal deterministic anomaly service implemented; /api/v1/anomaly-findings planned | Analytics visualization module implemented; API integration pending | unit and Neon persistence tests | MET-003, MET-004 | DEMO-001 | Implemented |
...
| MET-004 | Anomaly recall | Metrics | anomaly/metrics | controlled synthetic evaluation implemented; metrics API planned | metrics fixture UI | measured 1.0000 on four fixtures | MET-004 | DEMO-001 | Implemented |
| MET-005 | False-positive rate | Metrics | anomaly/metrics | controlled Eid/normal evaluation implemented; metrics API planned | metrics fixture UI | measured 0.0000 on four fixtures | MET-005 | DEMO-001 | Implemented |
