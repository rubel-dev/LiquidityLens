...
class LiquidityForecast(UuidPrimaryKeyMixin, CreatedAtMixin, Base):
    ...
    __table_args__ = (
        CheckConstraint("confidence >= 0 and confidence <= 1", name="ck_forecasts_confidence_range"),
...
class ConfidenceAssessment(UuidPrimaryKeyMixin, CreatedAtMixin, Base):
    ...
    __table_args__ = (
        CheckConstraint("confidence >= 0 and confidence <= 1", name="ck_confidence_assessments_range"),
